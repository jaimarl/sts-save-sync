...
1. **Uninstall** *Slay The Spire* from your Android device.
2. **Reinstall** the game from the Play Store.
3. **Launch** the game.
4. **Close** the game immediately after the developer logo appears.
5. Now you can run the `to_phone` command.
